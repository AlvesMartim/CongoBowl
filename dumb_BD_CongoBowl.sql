...
CREATE TABLE `article` (
  ...
  `status` varchar(10) NOT NULL DEFAULT 'brouillon',
  PRIMARY KEY (`id`),
  UNIQUE KEY `slug` (`slug`),
  CONSTRAINT `article_chk_1` CHECK ((`status` in (_utf8mb4'brouillon',_utf8mb4'publie')))
...
INSERT INTO `django_session` VALUES ('ho31yq1oucy0n623oovb4mmyfb8pp4al','.eJyrViotyczJLE4sSS0tii8oTi1NyVeyUkosKlHSQZHKzS-JT0mNL0gsLk4FKihIyk5JM4ovzkg0MjVTsTA3AAKVKrMcTyf_9OxKr8qUpEAf80gLv3BDQ5UA0yzPfIt0o9DEyMDCgjLXkvwAzyiDjMok45BKb5-wXCO3IL_MnGLT0khHWzRbM1OUrMxqAcbbOKg:1tJK04:0BXtiBlZnZmk6Eg212i5HRR2tbbKLMsFRCZoqG9i9Cs','2024-12-19 22:07:08.529333'),('sirzj12mvsyd5ocy41ds1tutpetasqyc','e30:1tGciO:Ioc5EL9vBT1FTXl14UIe3_jTia1T9s4VNOMCKk9xLZo','2024-12-12 11:29:44.119860');
...
INSERT INTO `utilisateur` VALUES (2,'Alves','Martim','m@gmail.com','marts','pbkdf2_sha256$870000$OTNt2LmamlYokBI3jdTfio$5aXFluQcKSRyis2dcc6BxDub2+y3y1BibIIU8Sb46hY=','2024-11-28 09:48:18'),(6,'a','a','art@gmail.com','art','pbkdf2_sha256$870000$z6lIBOgkyJydbQL7Y8NW11$P5jIo8g2UaYQqpvEtoPIZ0hyb3TyKLVm2FRNils5uYA=','2024-12-05 11:35:47');
...
-- Dump completed on 2024-12-19 10:19:16
